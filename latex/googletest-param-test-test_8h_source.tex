...
\hypertarget{googletest-param-test-test_8h_source}{}\label{googletest-param-test-test_8h_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/test/googletest-\/param-\/test-\/test.h@{RobotLib/libraries/assimp/contrib/googletest/googletest/test/googletest-\/param-\/test-\/test.h}}
\mbox{\hyperlink{googletest-param-test-test_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00042\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_external_instantiation_test}{ExternalInstantiationTest}}\ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_test_with_param}{::testing::TestWithParam}}<int>\ \{\};}
\DoxyCodeLine{00043\ }
...
\DoxyCodeLine{00046\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_instantiation_in_multiple_translation_units_test}{InstantiationInMultipleTranslationUnitsTest}}}
\DoxyCodeLine{00047\ \ \ \ \ :\ \textcolor{keyword}{public}\ \mbox{\hyperlink{classtesting_1_1_test_with_param}{::testing::TestWithParam}}<int>\ \{\};}
\DoxyCodeLine{00048\ }
