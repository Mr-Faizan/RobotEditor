...
\hypertarget{gtest-filepath_8cc_source}{}\label{gtest-filepath_8cc_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/src/gtest-\/filepath.cc@{RobotLib/libraries/assimp/contrib/googletest/googletest/src/gtest-\/filepath.cc}}
...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-filepath_8h}{gtest/internal/gtest-\/filepath.h}}"{}}}
\DoxyCodeLine{00031\ }
...
\DoxyCodeLine{00036\ }
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-message_8h}{gtest/gtest-\/message.h}}"{}}}
\DoxyCodeLine{00038\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-port_8h}{gtest/internal/gtest-\/port.h}}"{}}}
\DoxyCodeLine{00039\ }
...
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-string_8h}{gtest/internal/gtest-\/string.h}}"{}}}
\DoxyCodeLine{00052\ }
...
\DoxyCodeLine{00111\ \ \ \textcolor{keywordtype}{char}\ cwd[\mbox{\hyperlink{gtest-filepath_8cc_ad9d445747785a9271a57cf1d392b89ad}{GTEST\_PATH\_MAX\_}}\ +\ 1]\ =\ \{\textcolor{charliteral}{'\(\backslash\)0'}\};}
...
\DoxyCodeLine{00114\ \ \ \textcolor{keywordtype}{char}\ cwd[\mbox{\hyperlink{gtest-filepath_8cc_ad9d445747785a9271a57cf1d392b89ad}{GTEST\_PATH\_MAX\_}}\ +\ 1]\ =\ \{\textcolor{charliteral}{'\(\backslash\)0'}\};}
...
\DoxyCodeLine{00132\ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{class_string_a968f242b709f8c7c0ed5ecf246553321}{String::EndsWithCaseInsensitive}}(pathname\_,\ dot\_extension))\ \{}
...
\DoxyCodeLine{00201\ \ \ \textcolor{keywordflow}{return}\ last\_sep\ ?\ FilePath(last\_sep\ +\ 1)\ :\ *\textcolor{keyword}{this};}
\DoxyCodeLine{00202\ \}}
\DoxyCodeLine{00203\ }
...
\DoxyCodeLine{00235\ \ \ \ \ \ \ \ \ base\_name.string()\ +\ \textcolor{stringliteral}{"{}\_"{}}\ +\ \mbox{\hyperlink{namespacetesting_1_1internal_aad4beed95d0846e6ffc5da0978ef3bb9}{StreamableToString}}(number)\ +\ \textcolor{stringliteral}{"{}."{}}\ +\ extension;}
\DoxyCodeLine{00236\ \ \ \}}
...
\DoxyCodeLine{00258\ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a8eb9f08d3af29941c2d2a964cfff3ecb}{posix::StatStruct}}\ file\_stat\{\};}
\DoxyCodeLine{00259\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a2b87b7ff647a128614daf50667eb9304}{posix::Stat}}(pathname\_.c\_str(),\ \&file\_stat)\ ==\ 0;}
...
\DoxyCodeLine{00285\ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a8eb9f08d3af29941c2d2a964cfff3ecb}{posix::StatStruct}}\ file\_stat\{\};}
\DoxyCodeLine{00286\ \ \ result\ =}
\DoxyCodeLine{00287\ \ \ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a2b87b7ff647a128614daf50667eb9304}{posix::Stat}}(path.c\_str(),\ \&file\_stat)\ ==\ 0\ \&\&\ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_af0d04ed5baeed28353fa38742748a421}{posix::IsDir}}(file\_stat);}
...
\DoxyCodeLine{00379\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ *\textcolor{keyword}{this};}
\DoxyCodeLine{00380\ \}}
\DoxyCodeLine{00381\ }
...
\DoxyCodeLine{00387\ \ \ \textcolor{keyword}{auto}\ \mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}}\ =\ pathname\_.begin();}
\DoxyCodeLine{00388\ }
...
\DoxyCodeLine{00394\ \ \ \ \ *(\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}}++)\ =\ kPathSeparator;}
\DoxyCodeLine{00395\ \ \ \ \ *(\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}}++)\ =\ kPathSeparator;}
\DoxyCodeLine{00396\ \ \ \}}
...
\DoxyCodeLine{00401\ \ \ \ \ \ \ *(\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}}++)\ =\ character;}
\DoxyCodeLine{00402\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}}\ ==\ pathname\_.begin()\ ||\ *std::prev(\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}})\ !=\ kPathSeparator)\ \{}
\DoxyCodeLine{00403\ \ \ \ \ \ \ *(\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}}++)\ =\ kPathSeparator;}
\DoxyCodeLine{00404\ \ \ \ \ \}}
\DoxyCodeLine{00405\ \ \ \ \ ++i;}
\DoxyCodeLine{00406\ \ \ \}}
\DoxyCodeLine{00407\ }
\DoxyCodeLine{00408\ \ \ pathname\_.erase(\mbox{\hyperlink{_write_dump_8cpp_a1277960b5f2b37137fe9b0b5a1ea0beb}{out}},\ pathname\_.end());}
\DoxyCodeLine{00409\ \}}
\DoxyCodeLine{00410\ }
