...
\hypertarget{gtest-assertion-result_8h_source}{}\label{gtest-assertion-result_8h_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/include/gtest/gtest-\/assertion-\/result.h@{RobotLib/libraries/assimp/contrib/googletest/googletest/include/gtest/gtest-\/assertion-\/result.h}}
\mbox{\hyperlink{gtest-assertion-result_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-message_8h}{gtest/gtest-\/message.h}}"{}}}
\DoxyCodeLine{00047\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-port_8h}{gtest/internal/gtest-\/port.h}}"{}}}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \mbox{\hyperlink{gtest-port_8h_a86994cc68e844d8b82089c70408dfc61}{GTEST\_DISABLE\_MSC\_WARNINGS\_PUSH\_}}(4251\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \(\backslash\)}
\DoxyCodeLine{00050\ \textcolor{comment}{/*\ class\ A\ needs\ to\ have\ dll-\/interface\ to\ be\ used\ by\ clients\ of\ class\ B\ */})}
\DoxyCodeLine{00051\ }
\DoxyCodeLine{00052\ namespace\ \mbox{\hyperlink{namespacetesting}{testing}}\ \{}
\DoxyCodeLine{00053\ }
...
\DoxyCodeLine{00133\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ AssertionResult\ \{}
...
\DoxyCodeLine{00144\ \ \ \mbox{\hyperlink{gtest-port_8h_a86994cc68e844d8b82089c70408dfc61}{GTEST\_DISABLE\_MSC\_WARNINGS\_PUSH\_}}(4800\ \textcolor{comment}{/*\ forcing\ value\ to\ bool\ */})}
...
\DoxyCodeLine{00164\ \ \ \mbox{\hyperlink{gtest-port_8h_ab4c44546d6d9aced68993b87b608fc06}{GTEST\_DISABLE\_MSC\_WARNINGS\_POP\_}}()}
...
\DoxyCodeLine{00169\ \ \ \ \ \mbox{\hyperlink{pugixml_8cpp_aab8f818e90a34b18c1da140588eca88d}{swap}}(other);}
...
\DoxyCodeLine{00191\ \ \ AssertionResult\&\ \mbox{\hyperlink{googletest-param-test-test_8cc_ace98876cf2a052cf79eb12db5bc1817f}{operator<<}}(\textcolor{keyword}{const}\ T\&\ \mbox{\hyperlink{pointer_8h_a32aff7c6c4cd253fdf6563677afab5ce}{value}})\ \{}
\DoxyCodeLine{00192\ \ \ \ \ AppendMessage(\mbox{\hyperlink{class_message}{Message}}()\ <<\ \mbox{\hyperlink{pointer_8h_a32aff7c6c4cd253fdf6563677afab5ce}{value}});}
...
\DoxyCodeLine{00198\ \ \ AssertionResult\&\ \mbox{\hyperlink{googletest-param-test-test_8cc_ace98876cf2a052cf79eb12db5bc1817f}{operator<<}}(}
\DoxyCodeLine{00199\ \ \ \ \ \ \ ::std::ostream\&\ (*basic\_manipulator)(::std::ostream\&\ \mbox{\hyperlink{zlib_2contrib_2minizip_2ioapi_8h_a4ed0a20697a8c37f8af699a8ec6d76a8}{stream}}))\ \{}
\DoxyCodeLine{00200\ \ \ \ \ AppendMessage(\mbox{\hyperlink{class_message}{Message}}()\ <<\ basic\_manipulator);}
...
\DoxyCodeLine{00206\ \ \ \textcolor{keywordtype}{void}\ AppendMessage(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_message}{Message}}\&\ a\_message)\ \{}
\DoxyCodeLine{00207\ \ \ \ \ \textcolor{keywordflow}{if}\ (message\_\ ==\ \textcolor{keyword}{nullptr})\ message\_\ =\ ::std::make\_unique<::std::string>();}
\DoxyCodeLine{00208\ \ \ \ \ message\_-\/>append(a\_message.\mbox{\hyperlink{class_message_a2cdc4df62bdcc9df37651a1cf527704e}{GetString}}().c\_str());}
\DoxyCodeLine{00209\ \ \ \}}
\DoxyCodeLine{00210\ }
\DoxyCodeLine{00211\ \ \ \textcolor{comment}{//\ Swap\ the\ contents\ of\ this\ AssertionResult\ with\ other.}}
\DoxyCodeLine{00212\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{pugixml_8cpp_aab8f818e90a34b18c1da140588eca88d}{swap}}(AssertionResult\&\ other);}
\DoxyCodeLine{00213\ }
...
\DoxyCodeLine{00224\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ AssertionResult\ \mbox{\hyperlink{gtest__unittest_8cc_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}();}
\DoxyCodeLine{00225\ }
\DoxyCodeLine{00226\ \textcolor{comment}{//\ Makes\ a\ failed\ assertion\ result.}}
\DoxyCodeLine{00227\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ AssertionResult\ \mbox{\hyperlink{gtest__unittest_8cc_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}();}
\DoxyCodeLine{00228\ }
...
\DoxyCodeLine{00231\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ AssertionResult\ \mbox{\hyperlink{gtest__unittest_8cc_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_message}{Message}}\&\ msg);}
\DoxyCodeLine{00232\ }
\DoxyCodeLine{00233\ \}\ \ \textcolor{comment}{//\ namespace\ testing}}
\DoxyCodeLine{00234\ }
\DoxyCodeLine{00235\ \mbox{\hyperlink{gtest-port_8h_ab4c44546d6d9aced68993b87b608fc06}{GTEST\_DISABLE\_MSC\_WARNINGS\_POP\_}}()\ \ \textcolor{comment}{//\ 4251}}
\DoxyCodeLine{00236\ }
