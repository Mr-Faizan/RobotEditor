...
\hypertarget{gtest__pred__impl_8h_source}{}\label{gtest__pred__impl_8h_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/include/gtest/gtest\_pred\_impl.h@{RobotLib/libraries/assimp/contrib/googletest/googletest/include/gtest/gtest\_pred\_impl.h}}
...
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-assertion-result_8h}{gtest/gtest-\/assertion-\/result.h}}"{}}}
\DoxyCodeLine{00040\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-internal_8h}{gtest/internal/gtest-\/internal.h}}"{}}}
\DoxyCodeLine{00041\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-port_8h}{gtest/internal/gtest-\/port.h}}"{}}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetesting}{testing}}\ \{}
\DoxyCodeLine{00044\ }
...
\DoxyCodeLine{00087\ AssertionResult\ \mbox{\hyperlink{namespacetesting_a7f73180474723be6e92185d6fa9e7c9f}{AssertPred1Helper}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ pred\_text,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ e1,}
\DoxyCodeLine{00088\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Pred\ pred,\ \textcolor{keyword}{const}\ T1\&\ v1)\ \{}
\DoxyCodeLine{00089\ \ \ \textcolor{keywordflow}{if}\ (pred(v1))\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}();}
\DoxyCodeLine{00090\ }
\DoxyCodeLine{00091\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()}
...
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ \ <<\ e1\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v1);}
\DoxyCodeLine{00095\ \}}
\DoxyCodeLine{00096\ }
...
\DoxyCodeLine{00118\ AssertionResult\ \mbox{\hyperlink{namespacetesting_aa6587938029dd8733ecb885068f08247}{AssertPred2Helper}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ pred\_text,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ e1,}
...
\DoxyCodeLine{00121\ \ \ \textcolor{keywordflow}{if}\ (pred(v1,\ v2))\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}();}
\DoxyCodeLine{00122\ }
\DoxyCodeLine{00123\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()}
...
\DoxyCodeLine{00127\ \ \ \ \ \ \ \ \ \ <<\ e1\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v1)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00128\ \ \ \ \ \ \ \ \ \ <<\ e2\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v2);}
\DoxyCodeLine{00129\ \}}
\DoxyCodeLine{00130\ }
...
\DoxyCodeLine{00155\ AssertionResult\ \mbox{\hyperlink{namespacetesting_ac92dcbd00a0ffb2913e65d286e321a22}{AssertPred3Helper}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ pred\_text,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ e1,}
...
\DoxyCodeLine{00158\ \ \ \textcolor{keywordflow}{if}\ (pred(v1,\ v2,\ v3))\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}();}
\DoxyCodeLine{00159\ }
\DoxyCodeLine{00160\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()}
...
\DoxyCodeLine{00164\ \ \ \ \ \ \ \ \ \ <<\ e1\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v1)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00165\ \ \ \ \ \ \ \ \ \ <<\ e2\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v2)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00166\ \ \ \ \ \ \ \ \ \ <<\ e3\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v3);}
\DoxyCodeLine{00167\ \}}
\DoxyCodeLine{00168\ }
...
\DoxyCodeLine{00194\ AssertionResult\ \mbox{\hyperlink{namespacetesting_ae90c778d69db4682e8fd8baaa0a9f9cd}{AssertPred4Helper}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ pred\_text,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ e1,}
...
\DoxyCodeLine{00198\ \ \ \textcolor{keywordflow}{if}\ (pred(v1,\ v2,\ v3,\ v4))\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}();}
\DoxyCodeLine{00199\ }
\DoxyCodeLine{00200\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()}
...
\DoxyCodeLine{00204\ \ \ \ \ \ \ \ \ \ <<\ e1\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v1)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00205\ \ \ \ \ \ \ \ \ \ <<\ e2\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v2)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00206\ \ \ \ \ \ \ \ \ \ <<\ e3\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v3)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00207\ \ \ \ \ \ \ \ \ \ <<\ e4\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v4);}
\DoxyCodeLine{00208\ \}}
\DoxyCodeLine{00209\ }
...
\DoxyCodeLine{00236\ AssertionResult\ \mbox{\hyperlink{namespacetesting_addcf52b273ce17269cbf4956cfe600a6}{AssertPred5Helper}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ pred\_text,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ e1,}
...
\DoxyCodeLine{00241\ \ \ \textcolor{keywordflow}{if}\ (pred(v1,\ v2,\ v3,\ v4,\ v5))\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}();}
\DoxyCodeLine{00242\ }
\DoxyCodeLine{00243\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()}
...
\DoxyCodeLine{00247\ \ \ \ \ \ \ \ \ \ <<\ e1\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v1)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00248\ \ \ \ \ \ \ \ \ \ <<\ e2\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v2)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00249\ \ \ \ \ \ \ \ \ \ <<\ e3\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v3)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00250\ \ \ \ \ \ \ \ \ \ <<\ e4\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v4)\ <<\ \textcolor{stringliteral}{"{}\(\backslash\)n"{}}}
\DoxyCodeLine{00251\ \ \ \ \ \ \ \ \ \ <<\ e5\ <<\ \textcolor{stringliteral}{"{}\ evaluates\ to\ "{}}\ <<\ \mbox{\hyperlink{namespacetesting_aa5717bb1144edd1d262d310ba70c82ed}{::testing::PrintToString}}(v5);}
\DoxyCodeLine{00252\ \}}
\DoxyCodeLine{00253\ }
