...
\hypertarget{gmock-cardinalities_8cc_source}{}\label{gmock-cardinalities_8cc_source}\index{RobotLib/libraries/assimp/contrib/googletest/googlemock/src/gmock-\/cardinalities.cc@{RobotLib/libraries/assimp/contrib/googletest/googlemock/src/gmock-\/cardinalities.cc}}
...
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-cardinalities_8h}{gmock/gmock-\/cardinalities.h}}"{}}}
\DoxyCodeLine{00035\ }
...
\DoxyCodeLine{00041\ }
\DoxyCodeLine{00042\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-internal-utils_8h}{gmock/internal/gmock-\/internal-\/utils.h}}"{}}}
\DoxyCodeLine{00043\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest_8h}{gtest/gtest.h}}"{}}}
\DoxyCodeLine{00044\ }
\DoxyCodeLine{00045\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetesting}{testing}}\ \{}
\DoxyCodeLine{00046\ }
...
\DoxyCodeLine{00053\ \ \ \ \ \ \ :\ min\_(\mbox{\hyperlink{namespaceo3dgc_a15e29e6aae3f02efd9080a8100b9e26a}{min}}\ >=\ 0\ ?\ \mbox{\hyperlink{namespaceo3dgc_a15e29e6aae3f02efd9080a8100b9e26a}{min}}\ :\ 0),\ max\_(\mbox{\hyperlink{namespaceo3dgc_aa5020297c1cc1469b09ebb7da94cea6f}{max}}\ >=\ min\_\ ?\ \mbox{\hyperlink{namespaceo3dgc_aa5020297c1cc1469b09ebb7da94cea6f}{max}}\ :\ min\_)\ \{}
...
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{}but\ is\ actually\ "{}}\ <<\ \mbox{\hyperlink{namespaceo3dgc_a15e29e6aae3f02efd9080a8100b9e26a}{min}}\ <<\ \textcolor{stringliteral}{"{}."{}};}
\DoxyCodeLine{00058\ \ \ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_ad93379317e10862a77b9fb90aa96e083}{internal::Expect}}(\textcolor{keyword}{false},\ \_\_FILE\_\_,\ \_\_LINE\_\_,\ ss.str());}
...
\DoxyCodeLine{00061\ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{}but\ is\ actually\ "{}}\ <<\ \mbox{\hyperlink{namespaceo3dgc_aa5020297c1cc1469b09ebb7da94cea6f}{max}}\ <<\ \textcolor{stringliteral}{"{}."{}};}
\DoxyCodeLine{00062\ \ \ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_ad93379317e10862a77b9fb90aa96e083}{internal::Expect}}(\textcolor{keyword}{false},\ \_\_FILE\_\_,\ \_\_LINE\_\_,\ ss.str());}
\DoxyCodeLine{00063\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (min\ >\ max)\ \{}
\DoxyCodeLine{00064\ \ \ \ \ \ \ ss\ <<\ \textcolor{stringliteral}{"{}The\ invocation\ upper\ bound\ ("{}}\ <<\ \mbox{\hyperlink{namespaceo3dgc_aa5020297c1cc1469b09ebb7da94cea6f}{max}}}
\DoxyCodeLine{00065\ \ \ \ \ \ \ \ \ \ <<\ \textcolor{stringliteral}{"{})\ must\ be\ >=\ the\ invocation\ lower\ bound\ ("{}}\ <<\ \mbox{\hyperlink{namespaceo3dgc_a15e29e6aae3f02efd9080a8100b9e26a}{min}}\ <<\ \textcolor{stringliteral}{"{})."{}};}
\DoxyCodeLine{00066\ \ \ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_ad93379317e10862a77b9fb90aa96e083}{internal::Expect}}(\textcolor{keyword}{false},\ \_\_FILE\_\_,\ \_\_LINE\_\_,\ ss.str());}
\DoxyCodeLine{00067\ \ \ \ \ \}}
\DoxyCodeLine{00068\ \ \ \}}
\DoxyCodeLine{00069\ }
...
\DoxyCodeLine{00139\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Cardinality\ \mbox{\hyperlink{namespacetesting_a137297cb3c582843989fbd937cf0fed2}{AtLeast}}(\textcolor{keywordtype}{int}\ n)\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a3bb2d3cdd3fdf5b4be1480fce549918e}{Between}}(n,\ INT\_MAX);\ \}}
\DoxyCodeLine{00140\ }
\DoxyCodeLine{00141\ \textcolor{comment}{//\ Creates\ a\ cardinality\ that\ allows\ at\ most\ n\ calls.}}
\DoxyCodeLine{00142\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Cardinality\ \mbox{\hyperlink{namespacetesting_a5487cd1068c78821ced96fbf542a91bb}{AtMost}}(\textcolor{keywordtype}{int}\ n)\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a3bb2d3cdd3fdf5b4be1480fce549918e}{Between}}(0,\ n);\ \}}
\DoxyCodeLine{00143\ }
\DoxyCodeLine{00144\ \textcolor{comment}{//\ Creates\ a\ cardinality\ that\ allows\ any\ number\ of\ calls.}}
\DoxyCodeLine{00145\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Cardinality\ \mbox{\hyperlink{namespacetesting_aa1f8a6371097e1e9b8d6866020f35252}{AnyNumber}}()\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a137297cb3c582843989fbd937cf0fed2}{AtLeast}}(0);\ \}}
\DoxyCodeLine{00146\ }
\DoxyCodeLine{00147\ \textcolor{comment}{//\ Creates\ a\ cardinality\ that\ allows\ between\ min\ and\ max\ calls.}}
\DoxyCodeLine{00148\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Cardinality\ \mbox{\hyperlink{namespacetesting_a3bb2d3cdd3fdf5b4be1480fce549918e}{Between}}(\textcolor{keywordtype}{int}\ min,\ \textcolor{keywordtype}{int}\ max)\ \{}
...
\DoxyCodeLine{00153\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Cardinality\ \mbox{\hyperlink{namespacetesting_aa9b1b32ba9e8d3db8ac0af0fc8785c8d}{Exactly}}(\textcolor{keywordtype}{int}\ n)\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{namespacetesting_a3bb2d3cdd3fdf5b4be1480fce549918e}{Between}}(n,\ n);\ \}}
\DoxyCodeLine{00154\ }
