...
\hypertarget{sample1_8h_source}{}\label{sample1_8h_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/samples/sample1.h@{RobotLib/libraries/assimp/contrib/googletest/googletest/samples/sample1.h}}
...
\DoxyCodeLine{00036\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{sample1_8h_a0e7da4d7a69c5b5afb707807aa177017}{Factorial}}(\textcolor{keywordtype}{int}\ n);}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{comment}{//\ Returns\ true\ if\ and\ only\ if\ n\ is\ a\ prime\ number.}}
\DoxyCodeLine{00039\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{sample1_8h_a7093217f5edc11fe277d03bd064e5f11}{IsPrime}}(\textcolor{keywordtype}{int}\ n);}
\DoxyCodeLine{00040\ }
