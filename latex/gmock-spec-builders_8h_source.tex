...
\hypertarget{gmock-spec-builders_8h_source}{}\label{gmock-spec-builders_8h_source}\index{RobotLib/libraries/assimp/contrib/googletest/googlemock/include/gmock/gmock-\/spec-\/builders.h@{RobotLib/libraries/assimp/contrib/googletest/googlemock/include/gmock/gmock-\/spec-\/builders.h}}
...
\DoxyCodeLine{00075\ }
\DoxyCodeLine{00076\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-actions_8h}{gmock/gmock-\/actions.h}}"{}}}
\DoxyCodeLine{00077\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-cardinalities_8h}{gmock/gmock-\/cardinalities.h}}"{}}}
\DoxyCodeLine{00078\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-matchers_8h}{gmock/gmock-\/matchers.h}}"{}}}
\DoxyCodeLine{00079\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-internal-utils_8h}{gmock/internal/gmock-\/internal-\/utils.h}}"{}}}
\DoxyCodeLine{00080\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gmock-port_8h}{gmock/internal/gmock-\/port.h}}"{}}}
\DoxyCodeLine{00081\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest_8h}{gtest/gtest.h}}"{}}}
\DoxyCodeLine{00082\ }
...
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00087\ \mbox{\hyperlink{gtest-port_8h_a86994cc68e844d8b82089c70408dfc61}{GTEST\_DISABLE\_MSC\_WARNINGS\_PUSH\_}}(4251\ \(\backslash\)}
\DoxyCodeLine{00088\ \textcolor{comment}{/*\ class\ A\ needs\ to\ have\ dll-\/interface\ to\ be\ used\ by\ clients\ of\ class\ B\ */})}
\DoxyCodeLine{00089\ }
\DoxyCodeLine{00090\ namespace\ \mbox{\hyperlink{namespacetesting}{testing}}\ \{}
\DoxyCodeLine{00091\ }
...
\DoxyCodeLine{00135\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ \mbox{\hyperlink{gtest-port_8h_af0970cdea09f16dbb1dbfccdaa693eeb}{GTEST\_DECLARE\_STATIC\_MUTEX\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00136\ }
...
\DoxyCodeLine{00140\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ UntypedFunctionMockerBase\ \{}
...
\DoxyCodeLine{00149\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00150\ }
\DoxyCodeLine{00151\ \ \ \textcolor{comment}{//\ Clears\ the\ ON\_CALL()s\ set\ on\ this\ mock\ function.}}
\DoxyCodeLine{00152\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ ClearDefaultActionsLocked()}
\DoxyCodeLine{00153\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ =\ 0;}
\DoxyCodeLine{00154\ }
...
\DoxyCodeLine{00162\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ UntypedDescribeUninterestingCall(\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ untyped\_args,}
\DoxyCodeLine{00163\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ::std::ostream*\ os)\ \textcolor{keyword}{const}}
\DoxyCodeLine{00164\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ =\ 0;}
\DoxyCodeLine{00165\ }
...
\DoxyCodeLine{00172\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keyword}{const}\ ExpectationBase*\ UntypedFindMatchingExpectation(}
\DoxyCodeLine{00173\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ untyped\_args,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}**\ untyped\_action,\ \textcolor{keywordtype}{bool}*\ is\_excessive,}
\DoxyCodeLine{00174\ \ \ \ \ \ \ ::std::ostream*\ what,\ ::std::ostream*\ why)}
\DoxyCodeLine{00175\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ =\ 0;}
\DoxyCodeLine{00176\ }
\DoxyCodeLine{00177\ \ \ \textcolor{comment}{//\ Prints\ the\ given\ function\ arguments\ to\ the\ ostream.}}
\DoxyCodeLine{00178\ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ UntypedPrintArgs(\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ untyped\_args,}
\DoxyCodeLine{00179\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ::std::ostream*\ os)\ \textcolor{keyword}{const}\ =\ 0;}
\DoxyCodeLine{00180\ }
...
\DoxyCodeLine{00185\ \ \ \textcolor{keywordtype}{void}\ RegisterOwner(\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ mock\_obj)\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00186\ }
...
\DoxyCodeLine{00190\ \ \ \textcolor{keywordtype}{void}\ SetOwnerAndName(\textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ mock\_obj,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ name)}
\DoxyCodeLine{00191\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00192\ }
...
\DoxyCodeLine{00196\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ MockObject()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00197\ }
...
\DoxyCodeLine{00200\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ \mbox{\hyperlink{struct_name}{Name}}()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00201\ }
\DoxyCodeLine{00202\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00203\ \ \ \textcolor{keyword}{typedef}\ std::vector<const\ void*>\ UntypedOnCallSpecs;}
\DoxyCodeLine{00204\ }
\DoxyCodeLine{00205\ \ \ \textcolor{keyword}{using\ }UntypedExpectations\ =\ std::vector<std::shared\_ptr<ExpectationBase>>;}
\DoxyCodeLine{00206\ }
\DoxyCodeLine{00207\ \ \ \textcolor{keyword}{struct\ }UninterestingCallCleanupHandler;}
\DoxyCodeLine{00208\ \ \ \textcolor{keyword}{struct\ }FailureCleanupHandler;}
\DoxyCodeLine{00209\ }
...
\DoxyCodeLine{00217\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ mock\_obj\_;\ \ \textcolor{comment}{//\ Protected\ by\ g\_gmock\_mutex.}}
\DoxyCodeLine{00218\ }
...
\DoxyCodeLine{00221\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ name\_;\ \ \textcolor{comment}{//\ Protected\ by\ g\_gmock\_mutex.}}
\DoxyCodeLine{00222\ }
...
\DoxyCodeLine{00239\ \textcolor{keyword}{class\ }UntypedOnCallSpecBase\ \{}
...
\DoxyCodeLine{00262\ \ \ \ \ \mbox{\hyperlink{zutil_8h_a5c8d8d889189d1461d10df831f3cd40e}{Assert}}(property,\ file\_,\ line\_,\ failure\_message);}
\DoxyCodeLine{00263\ \ \ \}}
\DoxyCodeLine{00264\ }
...
\DoxyCodeLine{00298\ \ \ OnCallSpec\&\ With(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_matcher}{Matcher<const\ ArgumentTuple\&>}}\&\ m)\ \{}
...
\DoxyCodeLine{00310\ \ \ OnCallSpec\&\ WillByDefault(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}\&\ action)\ \{}
...
\DoxyCodeLine{00328\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}\&\ GetAction()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00350\ \ \ \mbox{\hyperlink{class_matcher}{Matcher<const\ ArgumentTuple\&>}}\ extra\_matcher\_;}
\DoxyCodeLine{00351\ \ \ \mbox{\hyperlink{class_action}{Action<F>}}\ action\_;}
...
\DoxyCodeLine{00364\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ \mbox{\hyperlink{class_mock}{Mock}}\ \{}
...
\DoxyCodeLine{00371\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00372\ }
...
\DoxyCodeLine{00377\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00378\ }
...
\DoxyCodeLine{00383\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00384\ }
...
\DoxyCodeLine{00387\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
...
\DoxyCodeLine{00390\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
...
\DoxyCodeLine{00393\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00394\ }
...
\DoxyCodeLine{00413\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00414\ }
...
\DoxyCodeLine{00418\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00419\ }
...
\DoxyCodeLine{00423\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00424\ }
...
\DoxyCodeLine{00428\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00429\ }
...
\DoxyCodeLine{00433\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{void}*\ mock\_obj)\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00434\ }
...
\DoxyCodeLine{00439\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00440\ }
...
\DoxyCodeLine{00443\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00444\ }
...
\DoxyCodeLine{00448\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00449\ }
...
\DoxyCodeLine{00455\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(internal::g\_gmock\_mutex);}
\DoxyCodeLine{00456\ }
...
\DoxyCodeLine{00462\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(internal::g\_gmock\_mutex);}
...
\DoxyCodeLine{00480\ }
\DoxyCodeLine{00481\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Expectation\ \{}
...
\DoxyCodeLine{00507\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{json_8hpp_a4fe1c9b8096b3c21d3dd1e19c3eff59f}{operator==}}(\textcolor{keyword}{const}\ Expectation\&\ rhs)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00508\ \ \ \ \ \textcolor{keywordflow}{return}\ expectation\_base\_\ ==\ rhs.expectation\_base\_;}
\DoxyCodeLine{00509\ \ \ \}}
\DoxyCodeLine{00510\ }
\DoxyCodeLine{00511\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{json_8hpp_ac45cd9ddda9dd7a4682f0c57f4077fc1}{operator!=}}(\textcolor{keyword}{const}\ Expectation\&\ rhs)\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ !(*\textcolor{keyword}{this}\ ==\ rhs);\ \}}
\DoxyCodeLine{00512\ }
...
\DoxyCodeLine{00590\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{json_8hpp_a4fe1c9b8096b3c21d3dd1e19c3eff59f}{operator==}}(\textcolor{keyword}{const}\ ExpectationSet\&\ rhs)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00591\ \ \ \ \ \textcolor{keywordflow}{return}\ expectations\_\ ==\ rhs.expectations\_;}
\DoxyCodeLine{00592\ \ \ \}}
\DoxyCodeLine{00593\ }
\DoxyCodeLine{00594\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{json_8hpp_ac45cd9ddda9dd7a4682f0c57f4077fc1}{operator!=}}(\textcolor{keyword}{const}\ ExpectationSet\&\ rhs)\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ !(*\textcolor{keyword}{this}\ ==\ rhs);\ \}}
\DoxyCodeLine{00595\ }
...
\DoxyCodeLine{00601\ \ \ \}}
\DoxyCodeLine{00602\ }
\DoxyCodeLine{00603\ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{zlib_2contrib_2minizip_2ioapi_8h_a014d89bd76f74ef3a29c8f04b473eb76}{size}}()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{int}\textcolor{keyword}{>}(expectations\_.size());\ \}}
\DoxyCodeLine{00604\ }
...
\DoxyCodeLine{00615\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ Sequence\ \{}
\DoxyCodeLine{00616\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{00617\ \ \ \textcolor{comment}{//\ Constructs\ an\ empty\ sequence.}}
\DoxyCodeLine{00618\ \ \ Sequence()\ :\ last\_expectation\_(\textcolor{keyword}{new}\ Expectation)\ \{\}}
\DoxyCodeLine{00619\ }
...
\DoxyCodeLine{00653\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ InSequence\ \{}
...
\DoxyCodeLine{00663\ \};}
\DoxyCodeLine{00664\ }
\DoxyCodeLine{00665\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespaceinternal}{internal}}\ \{}
\DoxyCodeLine{00666\ }
...
\DoxyCodeLine{00669\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ \textcolor{keyword}{extern}\ ThreadLocal<Sequence*>\ g\_gmock\_implicit\_sequence;}
\DoxyCodeLine{00670\ }
...
\DoxyCodeLine{00685\ \textcolor{keyword}{class\ }\mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ ExpectationBase\ \{}
...
\DoxyCodeLine{00707\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00708\ }
...
\DoxyCodeLine{00744\ \ \ \ \ \mbox{\hyperlink{zutil_8h_a5c8d8d889189d1461d10df831f3cd40e}{Assert}}(property,\ file\_,\ line\_,\ failure\_message);}
\DoxyCodeLine{00745\ \ \ \}}
\DoxyCodeLine{00746\ }
...
\DoxyCodeLine{00771\ \ \ \textcolor{keywordtype}{void}\ RetireAllPreRequisites()\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00772\ }
\DoxyCodeLine{00773\ \ \ \textcolor{comment}{//\ Returns\ true\ if\ and\ only\ if\ this\ expectation\ is\ retired.}}
\DoxyCodeLine{00774\ \ \ \textcolor{keywordtype}{bool}\ is\_retired()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00780\ \ \ \textcolor{keywordtype}{void}\ Retire()\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00790\ \ \ \textcolor{keywordtype}{bool}\ IsSatisfied()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00796\ \ \ \textcolor{keywordtype}{bool}\ IsSaturated()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00802\ \ \ \textcolor{keywordtype}{bool}\ IsOverSaturated()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00809\ \ \ \textcolor{keywordtype}{bool}\ AllPrerequisitesAreSatisfied()\ \textcolor{keyword}{const}}
\DoxyCodeLine{00810\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00811\ }
\DoxyCodeLine{00812\ \ \ \textcolor{comment}{//\ Adds\ unsatisfied\ pre-\/requisites\ of\ this\ expectation\ to\ 'result'.}}
\DoxyCodeLine{00813\ \ \ \textcolor{keywordtype}{void}\ FindUnsatisfiedPrerequisites(ExpectationSet*\ result)\ \textcolor{keyword}{const}}
\DoxyCodeLine{00814\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex);}
\DoxyCodeLine{00815\ }
\DoxyCodeLine{00816\ \ \ \textcolor{comment}{//\ Returns\ the\ number\ this\ expectation\ has\ been\ invoked.}}
\DoxyCodeLine{00817\ \ \ \textcolor{keywordtype}{int}\ call\_count()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00823\ \ \ \textcolor{keywordtype}{void}\ IncrementCallCount()\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{00832\ \ \ \textcolor{keywordtype}{void}\ CheckActionCountIfNotDone()\ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(mutex\_);}
\DoxyCodeLine{00833\ }
\DoxyCodeLine{00834\ \ \ \textcolor{keyword}{friend}\ class\ ::testing::Sequence;}
\DoxyCodeLine{00835\ \ \ \textcolor{keyword}{friend}\ class\ ::testing::internal::ExpectationTester;}
\DoxyCodeLine{00836\ }
\DoxyCodeLine{00837\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Function>}
\DoxyCodeLine{00838\ \ \ \textcolor{keyword}{friend}\ \textcolor{keyword}{class\ }TypedExpectation;}
\DoxyCodeLine{00839\ }
\DoxyCodeLine{00840\ \ \ \textcolor{comment}{//\ Implements\ the\ .Times()\ clause.}}
\DoxyCodeLine{00841\ \ \ \textcolor{keywordtype}{void}\ UntypedTimes(\textcolor{keyword}{const}\ Cardinality\&\ a\_cardinality);}
\DoxyCodeLine{00842\ }
...
\DoxyCodeLine{00845\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ file\_;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ The\ file\ that\ contains\ the\ expectation.}}
\DoxyCodeLine{00846\ \ \ \textcolor{keywordtype}{int}\ line\_;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ The\ line\ number\ of\ the\ expectation.}}
\DoxyCodeLine{00847\ \ \ \textcolor{keyword}{const}\ std::string\ source\_text\_;\ \ \textcolor{comment}{//\ The\ EXPECT\_CALL(...)\ source\ text.}}
\DoxyCodeLine{00848\ \ \ std::string\ description\_;\ \ \ \ \ \ \ \ \textcolor{comment}{//\ User-\/readable\ name\ for\ the\ expectation.}}
...
\DoxyCodeLine{00869\ \ \ \textcolor{keyword}{mutable}\ \textcolor{keywordtype}{bool}\ action\_count\_checked\_;\ \ \textcolor{comment}{//\ Under\ mutex\_.}}
\DoxyCodeLine{00870\ \ \ \textcolor{keyword}{mutable}\ Mutex\ mutex\_;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Protects\ action\_count\_checked\_.}}
\DoxyCodeLine{00871\ \};\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ class\ ExpectationBase}}
\DoxyCodeLine{00872\ }
\DoxyCodeLine{00873\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ F>}
\DoxyCodeLine{00874\ \textcolor{keyword}{class\ }TypedExpectation;}
\DoxyCodeLine{00875\ }
\DoxyCodeLine{00876\ \textcolor{comment}{//\ Implements\ an\ expectation\ for\ the\ given\ function\ type.}}
\DoxyCodeLine{00877\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ R,\ \textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00878\ \textcolor{keyword}{class\ }TypedExpectation<R(Args...)>\ :\ \textcolor{keyword}{public}\ ExpectationBase\ \{}
...
\DoxyCodeLine{00897\ \ \ \ \ \ \ \ \ repeated\_action\_(\mbox{\hyperlink{gmock__link__test_8h_ae041df61ff61ccb9753ba15b4309e1a6}{DoDefault}}())\ \{\}}
\DoxyCodeLine{00898\ }
...
\DoxyCodeLine{00905\ \ \ \ \ \ \ \textcolor{keyword}{delete}\ \textcolor{keyword}{static\_cast<}\textcolor{keyword}{const\ }\mbox{\hyperlink{class_action}{Action<F>}}*\textcolor{keyword}{>}(*it);}
\DoxyCodeLine{00906\ \ \ \ \ \}}
\DoxyCodeLine{00907\ \ \ \}}
\DoxyCodeLine{00908\ }
\DoxyCodeLine{00909\ \ \ \textcolor{comment}{//\ Implements\ the\ .With()\ clause.}}
\DoxyCodeLine{00910\ \ \ TypedExpectation\&\ With(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_matcher}{Matcher<const\ ArgumentTuple\&>}}\&\ m)\ \{}
...
\DoxyCodeLine{01007\ \ \ \ \ \textcolor{keywordflow}{return}\ WillOnce(\mbox{\hyperlink{class_action}{Action<F>}}(ActionAdaptor\{}
...
\DoxyCodeLine{01018\ \ \ TypedExpectation\&\ WillOnce(\mbox{\hyperlink{class_action}{Action<F>}}\ action)\ \{}
...
\DoxyCodeLine{01023\ }
\DoxyCodeLine{01024\ \ \ \ \ untyped\_actions\_.push\_back(\textcolor{keyword}{new}\ \mbox{\hyperlink{class_action}{Action<F>}}(std::move(action)));}
\DoxyCodeLine{01025\ }
...
\DoxyCodeLine{01033\ \ \ TypedExpectation\&\ WillRepeatedly(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}\&\ action)\ \{}
...
\DoxyCodeLine{01076\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_matcher}{Matcher<const\ ArgumentTuple\&>}}\&\ extra\_matcher()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{01081\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}\&\ repeated\_action()\textcolor{keyword}{\ const\ }\{\ \textcolor{keywordflow}{return}\ repeated\_action\_;\ \}}
\DoxyCodeLine{01082\ }
...
\DoxyCodeLine{01117\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01125\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01139\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01181\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}\&\ GetCurrentAction(\textcolor{keyword}{const}\ FunctionMocker<F>*\ mocker,}
\DoxyCodeLine{01182\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ ArgumentTuple\&\ args)\ \textcolor{keyword}{const}}
\DoxyCodeLine{01183\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01186\ \ \ \ \ \mbox{\hyperlink{zutil_8h_a5c8d8d889189d1461d10df831f3cd40e}{Assert}}(count\ >=\ 1,\ \_\_FILE\_\_,\ \_\_LINE\_\_,}
...
\DoxyCodeLine{01206\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ?\ *\textcolor{keyword}{static\_cast<}\textcolor{keyword}{const\ }\mbox{\hyperlink{class_action}{Action<F>}}*\textcolor{keyword}{>}(}
...
\DoxyCodeLine{01218\ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}*\ GetActionForArguments(\textcolor{keyword}{const}\ FunctionMocker<F>*\ mocker,}
...
\DoxyCodeLine{01222\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01259\ \ \ \mbox{\hyperlink{class_matcher}{Matcher<const\ ArgumentTuple\&>}}\ extra\_matcher\_;}
\DoxyCodeLine{01260\ \ \ \mbox{\hyperlink{class_action}{Action<F>}}\ repeated\_action\_;}
\DoxyCodeLine{01261\ }
...
\DoxyCodeLine{01277\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ \textcolor{keywordtype}{void}\ LogWithLocation(\mbox{\hyperlink{namespacetesting_1_1internal_a203d1a8a2147a53d12bbdae40d443914}{testing::internal::LogSeverity}}\ severity,}
...
\DoxyCodeLine{01346\ \ \ \textcolor{keyword}{explicit}\ ReferenceOrValueWrapper(T\ \mbox{\hyperlink{pointer_8h_a32aff7c6c4cd253fdf6563677afab5ce}{value}})\ :\ value\_(std::move(\mbox{\hyperlink{pointer_8h_a32aff7c6c4cd253fdf6563677afab5ce}{value}}))\ \{\}}
\DoxyCodeLine{01347\ }
...
\DoxyCodeLine{01389\ \mbox{\hyperlink{gtest-port_8h_aa73be6f0ba4a7456180a94904ce17790}{GTEST\_API\_}}\ \textcolor{keywordtype}{void}\ ReportUninterestingCall(CallReaction\ reaction,}
...
\DoxyCodeLine{01469\ \ \ \string~FunctionMocker()\ \textcolor{keyword}{override}\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01512\ \ \ \ \ \mbox{\hyperlink{zutil_8h_a5c8d8d889189d1461d10df831f3cd40e}{Assert}}(DefaultValue<Result>::Exists(),\ \textcolor{stringliteral}{"{}"{}},\ -\/1,\ message);}
...
\DoxyCodeLine{01519\ \ \ \textcolor{keywordtype}{void}\ ClearDefaultActionsLocked()\ \textcolor{keyword}{override}}
\DoxyCodeLine{01520\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01547\ \ \ Result\ \mbox{\hyperlink{gmock__link__test_8h_af5cacf4475557b5a3e37af3836564235}{Invoke}}(Args...\ args)\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
\DoxyCodeLine{01548\ \ \ \ \ \textcolor{keywordflow}{return}\ InvokeWith(ArgumentTuple(std::forward<Args>(args)...));}
\DoxyCodeLine{01549\ \ \ \}}
\DoxyCodeLine{01550\ }
\DoxyCodeLine{01551\ \ \ MockSpec<F>\ With(\mbox{\hyperlink{class_matcher}{Matcher<Args>}}...\ m)\ \{}
...
\DoxyCodeLine{01562\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01573\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01618\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01623\ \ \ \ \ *os\ <<\ \textcolor{stringliteral}{"{}\ \ \ \ Function\ call:\ "{}}\ <<\ \mbox{\hyperlink{struct_name}{Name}}();}
...
\DoxyCodeLine{01646\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01660\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}*\ action\ =\ exp-\/>GetActionForArguments(\textcolor{keyword}{this},\ args,\ what,\ why);}
...
\DoxyCodeLine{01678\ \ \ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01698\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01709\ \ \ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a149f693bd59fa1bc937af54c0cdcb32f}{GTEST\_EXCLUSIVE\_LOCK\_REQUIRED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01741\ \ \ \ \ \textcolor{keyword}{const}\ \mbox{\hyperlink{class_action}{Action<F>}}\ action\ =\ *\textcolor{keyword}{static\_cast<}\textcolor{keyword}{const\ }\mbox{\hyperlink{class_action}{Action<F>}}*\textcolor{keyword}{>}(untyped\_action);}
...
\DoxyCodeLine{01772\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ internal::negation<can\_print\_result<T>>\mbox{\hyperlink{pointer_8h_a32aff7c6c4cd253fdf6563677afab5ce}{::value}},\ \textcolor{keywordtype}{int}>::type\ =\ 0>}
...
\DoxyCodeLine{01783\ \ \ R\ InvokeWith(ArgumentTuple\&\&\ args)\ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex);}
...
\DoxyCodeLine{01790\ \ \ \ \ \mbox{\hyperlink{gtest-port_8h_a69abff5a4efdd07bd5faebe3dd318d06}{GTEST\_LOCK\_EXCLUDED\_}}(g\_gmock\_mutex)\ \{}
...
\DoxyCodeLine{01818\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{true};}
\DoxyCodeLine{01819\ }
...
\DoxyCodeLine{01823\ \ \ \ \ \ \ \ \ \ \ std::move(args),\ \textcolor{stringliteral}{"{}Function\ call:\ "{}}\ +\ std::string(\mbox{\hyperlink{struct_name}{Name}}()));}
\DoxyCodeLine{01824\ \ \ \ \ \}}
\DoxyCodeLine{01825\ }
...
\DoxyCodeLine{01871\ \ \ \}}
\DoxyCodeLine{01872\ }
\DoxyCodeLine{01873\ \ \ ss\ <<\ \textcolor{stringliteral}{"{}\ \ \ \ Function\ call:\ "{}}\ <<\ \mbox{\hyperlink{struct_name}{Name}}();}
...
\DoxyCodeLine{01901\ }
\DoxyCodeLine{01902\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespaceinternal}{internal}}\ \{}
\DoxyCodeLine{01903\ }
...
\DoxyCodeLine{01923\ \ \ \}}
\DoxyCodeLine{01924\ }
\DoxyCodeLine{01925\ \ \ MockSpec<R(Args...)>\ gmock\_Call(\mbox{\hyperlink{class_matcher}{Matcher<Args>}}...\ m)\ \{}
...
\DoxyCodeLine{01964\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ typename\ \mbox{\hyperlink{namespacestd}{std}}::enable\_if<std::is\_function<F>::value>::type>}
...
\DoxyCodeLine{02034\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{class_base}{Base}}\ =\ internal::MockFunction<internal::SignatureOfT<F>>;}
\DoxyCodeLine{02035\ }
\DoxyCodeLine{02036\ \ \textcolor{keyword}{public}:}
\DoxyCodeLine{02037\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{class_base_a1d5f3fb92f8cbc687705785bdc6abd18}{Base::Base}};}
\DoxyCodeLine{02038\ \};}
\DoxyCodeLine{02039\ }
...
\DoxyCodeLine{02072\ }
\DoxyCodeLine{02073\ \mbox{\hyperlink{gtest-port_8h_ab4c44546d6d9aced68993b87b608fc06}{GTEST\_DISABLE\_MSC\_WARNINGS\_POP\_}}()\ \ \textcolor{comment}{//\ \ 4251}}
\DoxyCodeLine{02074\ }
