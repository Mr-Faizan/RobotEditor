...
\hypertarget{sample4_8h_source}{}\label{sample4_8h_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/samples/sample4.h@{RobotLib/libraries/assimp/contrib/googletest/googletest/samples/sample4.h}}
...
\DoxyCodeLine{00035\ \textcolor{keyword}{class\ }\mbox{\hyperlink{class_counter_a1e05f69b5240fbab3e7ab351672167f0}{Counter}}\ \{}
...
\DoxyCodeLine{00041\ \ \ \mbox{\hyperlink{class_counter_a1e05f69b5240fbab3e7ab351672167f0}{Counter}}()\ :\ counter\_(0)\ \{\}}
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \ \ \textcolor{comment}{//\ Returns\ the\ current\ counter\ value,\ and\ increments\ it.}}
\DoxyCodeLine{00044\ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{class_counter_a0a0ca9fdb580a2aec9a5a62ebed2b5ab}{Increment}}();}
\DoxyCodeLine{00045\ }
\DoxyCodeLine{00046\ \ \ \textcolor{comment}{//\ Returns\ the\ current\ counter\ value,\ and\ decrements\ it.}}
\DoxyCodeLine{00047\ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{class_counter_aa58d9b4f0bd96fc2331234493eb21bed}{Decrement}}();}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \ \ \textcolor{comment}{//\ Prints\ the\ current\ counter\ value\ to\ STDOUT.}}
\DoxyCodeLine{00050\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{class_counter_a80092ec2a0deea0870b2e9f8ad0906bd}{Print}}()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00051\ \};}
\DoxyCodeLine{00052\ }
