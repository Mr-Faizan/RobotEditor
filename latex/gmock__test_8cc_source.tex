...
\hypertarget{gmock__test_8cc_source}{}\label{gmock__test_8cc_source}\index{RobotLib/libraries/assimp/contrib/googletest/googlemock/test/gmock\_test.cc@{RobotLib/libraries/assimp/contrib/googletest/googlemock/test/gmock\_test.cc}}
...
\DoxyCodeLine{00042\ }
\DoxyCodeLine{00043\ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacetesting_a32b1c6db9ba5133ccabfa67616b3c041}{testing::InitGoogleMock}};}
\DoxyCodeLine{00044\ }
...
\DoxyCodeLine{00048\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{gmock__test_8cc_ac9c8ae8722c330d47f75dee43fb8ab78}{TestInitGoogleMock}}(\textcolor{keyword}{const}\ Char*\ (\&argv)[M],\ \textcolor{keyword}{const}\ Char*\ (\&new\_argv)[\mbox{\hyperlink{crc32_8c_a0240ac851181b84ac374872dc5434ee4}{N}}],}
...
\DoxyCodeLine{00053\ \ \ \mbox{\hyperlink{gmock__test_8cc_a32b1c6db9ba5133ccabfa67616b3c041}{InitGoogleMock}}(\&argc,\ \textcolor{keyword}{const\_cast<}Char**\textcolor{keyword}{>}(argv));}
\DoxyCodeLine{00054\ \ \ \mbox{\hyperlink{gtest_8h_a1a6db8b1338ee7040329322b77779086}{ASSERT\_EQ}}(\mbox{\hyperlink{crc32_8c_a0240ac851181b84ac374872dc5434ee4}{N}}\ -\/\ 1,\ argc)\ <<\ \textcolor{stringliteral}{"{}The\ new\ argv\ has\ wrong\ number\ of\ elements."{}};}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ i\ =\ 0;\ i\ <\ \mbox{\hyperlink{crc32_8c_a0240ac851181b84ac374872dc5434ee4}{N}};\ i++)\ \{}
\DoxyCodeLine{00057\ \ \ \ \ \mbox{\hyperlink{gtest_8h_ad20f7b94ac5081e16f0005b94e95f0c6}{EXPECT\_STREQ}}(new\_argv[i],\ argv[i]);}
\DoxyCodeLine{00058\ \ \ \}}
\DoxyCodeLine{00059\ }
