...
\hypertarget{googletest-options-test_8cc_source}{}\label{googletest-options-test_8cc_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/test/googletest-\/options-\/test.cc@{RobotLib/libraries/assimp/contrib/googletest/googletest/test/googletest-\/options-\/test.cc}}
...
\DoxyCodeLine{00123\ \ \ \textcolor{keywordflow}{if}\ (!success)\ \mbox{\hyperlink{_blender_scene_8h_abb508ea8227673f419e9fe3a86c30d8e}{FAIL}}()\ <<\ \textcolor{stringliteral}{"{}GetCurrentExecutableName()\ returns\ "{}}\ <<\ exe\_str;}
\DoxyCodeLine{00124\ \}}
\DoxyCodeLine{00125\ }
...
\DoxyCodeLine{00132\ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a1ddc8a4fc6bb21da372307485591a212}{posix::ChDir}}(\textcolor{stringliteral}{"{}.."{}});}
\DoxyCodeLine{00133\ \ \ \ \ \textcolor{comment}{//\ This\ will\ make\ the\ test\ fail\ if\ run\ from\ the\ root\ directory.}}
\DoxyCodeLine{00134\ \ \ \ \ \mbox{\hyperlink{gtest_8h_a6ae7443947f25abc58bfcfcfc56b0d75}{EXPECT\_NE}}(original\_working\_dir\_.string(),}
...
\DoxyCodeLine{00139\ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a1ddc8a4fc6bb21da372307485591a212}{posix::ChDir}}(original\_working\_dir\_.string().c\_str());}
\DoxyCodeLine{00140\ \ \ \}}
\DoxyCodeLine{00141\ }
\DoxyCodeLine{00142\ \ \ FilePath\ original\_working\_dir\_;}
\DoxyCodeLine{00143\ \};}
\DoxyCodeLine{00144\ }
\DoxyCodeLine{00145\ \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithDefault)\ \{}
\DoxyCodeLine{00146\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00147\ \ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(}
...
\DoxyCodeLine{00150\ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}());}
\DoxyCodeLine{00151\ \}}
\DoxyCodeLine{00152\ }
\DoxyCodeLine{00153\ \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithDefaultXML)\ \{}
\DoxyCodeLine{00154\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}xml"{}});}
\DoxyCodeLine{00155\ \ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(}
...
\DoxyCodeLine{00158\ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}());}
\DoxyCodeLine{00159\ \}}
\DoxyCodeLine{00160\ }
\DoxyCodeLine{00161\ \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithRelativeFile)\ \{}
\DoxyCodeLine{00162\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}xml:filename.abc"{}});}
...
\DoxyCodeLine{00166\ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}());}
\DoxyCodeLine{00167\ \}}
\DoxyCodeLine{00168\ }
\DoxyCodeLine{00169\ \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithRelativePath)\ \{}
\DoxyCodeLine{00170\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}xml:path"{}}\ \mbox{\hyperlink{gtest-port_8h_afbb636e91bdd50267dbef11a50490b29}{GTEST\_PATH\_SEP\_}});}
...
\DoxyCodeLine{00174\ \ \ \ \ \ \ \ \ \ \ FilePath(std::string(\textcolor{stringliteral}{"{}path"{}})\ +\ \mbox{\hyperlink{gtest-port_8h_afbb636e91bdd50267dbef11a50490b29}{GTEST\_PATH\_SEP\_}}\ +}
...
\DoxyCodeLine{00178\ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}();}
\DoxyCodeLine{00179\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00180\ \ \ \mbox{\hyperlink{gtest_8h_a740cab7e3eec5c178a64b4f558bde66e}{EXPECT\_STRCASEEQ}}(expected\_output\_file.c\_str(),\ output\_file.c\_str());}
\DoxyCodeLine{00181\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00182\ \ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(expected\_output\_file,\ output\_file.c\_str());}
\DoxyCodeLine{00183\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00184\ \}}
\DoxyCodeLine{00185\ }
\DoxyCodeLine{00186\ \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithAbsoluteFile)\ \{}
\DoxyCodeLine{00187\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00188\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}xml:c:\(\backslash\)\(\backslash\)tmp\(\backslash\)\(\backslash\)filename.abc"{}});}
\DoxyCodeLine{00189\ \ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(FilePath(\textcolor{stringliteral}{"{}c:\(\backslash\)\(\backslash\)tmp\(\backslash\)\(\backslash\)filename.abc"{}}).\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00190\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}());}
\DoxyCodeLine{00191\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00192\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}xml:/tmp/filename.abc"{}});}
\DoxyCodeLine{00193\ \ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(FilePath(\textcolor{stringliteral}{"{}/tmp/filename.abc"{}}).\textcolor{keywordtype}{string}(),}
\DoxyCodeLine{00194\ \ \ \ \ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}());}
\DoxyCodeLine{00195\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00196\ \}}
\DoxyCodeLine{00197\ }
\DoxyCodeLine{00198\ \mbox{\hyperlink{gtest_8h_a0ee66d464d1a06c20c1929cae09d8758}{TEST\_F}}(XmlOutputChangeDirTest,\ PreserveOriginalWorkingDirWithAbsolutePath)\ \{}
\DoxyCodeLine{00199\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00200\ \ \ \textcolor{keyword}{const}\ std::string\ \mbox{\hyperlink{namespace_assimp_1_1_d3_m_f_1_1_xml_tag_a65976964b929d459ca3569243d46ad7f}{path}}\ =\ \textcolor{stringliteral}{"{}c:\(\backslash\)\(\backslash\)tmp\(\backslash\)\(\backslash\)"{}};}
\DoxyCodeLine{00201\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00202\ \ \ \textcolor{keyword}{const}\ std::string\ \mbox{\hyperlink{namespace_assimp_1_1_d3_m_f_1_1_xml_tag_a65976964b929d459ca3569243d46ad7f}{path}}\ =\ \textcolor{stringliteral}{"{}/tmp/"{}};}
\DoxyCodeLine{00203\ \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{00204\ }
\DoxyCodeLine{00205\ \ \ \mbox{\hyperlink{gtest-port_8h_aa853dfc7a440ce6989b66d15baaee1a2}{GTEST\_FLAG\_SET}}(output,\ \textcolor{stringliteral}{"{}xml:"{}}\ +\ path);}
\DoxyCodeLine{00206\ \ \ \textcolor{keyword}{const}\ std::string\ expected\_output\_file\ =}
\DoxyCodeLine{00207\ \ \ \ \ \ \ \mbox{\hyperlink{namespace_assimp_1_1_d3_m_f_1_1_xml_tag_a65976964b929d459ca3569243d46ad7f}{path}}\ +\ GetCurrentExecutableName().string()\ +\ \textcolor{stringliteral}{"{}.xml"{}};}
\DoxyCodeLine{00208\ \ \ \textcolor{keyword}{const}\ std::string\&\ output\_file\ =}
\DoxyCodeLine{00209\ \ \ \ \ \ \ \mbox{\hyperlink{classtesting_1_1internal_1_1_unit_test_options_a8b29c6a22fd2f904c6b0453e403f58fa}{UnitTestOptions::GetAbsolutePathToOutputFile}}();}
\DoxyCodeLine{00210\ }
\DoxyCodeLine{00211\ \textcolor{preprocessor}{\#ifdef\ GTEST\_OS\_WINDOWS}}
\DoxyCodeLine{00212\ \ \ \mbox{\hyperlink{gtest_8h_a740cab7e3eec5c178a64b4f558bde66e}{EXPECT\_STRCASEEQ}}(expected\_output\_file.c\_str(),\ output\_file.c\_str());}
\DoxyCodeLine{00213\ \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{00214\ \ \ \mbox{\hyperlink{gtest_8h_a4159019abda84f5366acdb7604ff220a}{EXPECT\_EQ}}(expected\_output\_file,\ output\_file.c\_str());}
