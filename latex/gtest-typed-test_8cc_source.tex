...
\hypertarget{gtest-typed-test_8cc_source}{}\label{gtest-typed-test_8cc_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/src/gtest-\/typed-\/test.cc@{RobotLib/libraries/assimp/contrib/googletest/googletest/src/gtest-\/typed-\/test.cc}}
...
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-typed-test_8h}{gtest/gtest-\/typed-\/test.h}}"{}}}
\DoxyCodeLine{00031\ }
...
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest_8h}{gtest/gtest.h}}"{}}}
\DoxyCodeLine{00037\ }
\DoxyCodeLine{00038\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetesting}{testing}}\ \{}
\DoxyCodeLine{00039\ \textcolor{keyword}{namespace\ }\mbox{\hyperlink{namespacetesting_1_1internal}{internal}}\ \{}
\DoxyCodeLine{00040\ }
...
\DoxyCodeLine{00044\ \ \ \textcolor{keywordflow}{while}\ (\mbox{\hyperlink{namespacetesting_1_1internal_af429e04f70f9c10f6aa76a5d1ccd389f}{IsSpace}}(*str))\ str++;}
...
\DoxyCodeLine{00051\ \ \ \textcolor{keywordflow}{for}\ (;\ src\ !=\ \textcolor{keyword}{nullptr};\ src\ =\ \mbox{\hyperlink{namespacetesting_1_1internal_ad5c552225eb46fca3889e6cd6486278d}{SkipComma}}(src))\ \{}
\DoxyCodeLine{00052\ \ \ \ \ name\_vec.push\_back(\mbox{\hyperlink{namespacetesting_1_1internal_aa6afda12e567c353e2e9b9c2e8cae14f}{StripTrailingSpaces}}(\mbox{\hyperlink{namespacetesting_1_1internal_a42d633fb359d696157347720aa0ff66c}{GetPrefixUntilComma}}(src)));}
\DoxyCodeLine{00053\ \ \ \}}
...
\DoxyCodeLine{00063\ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_a44068e2445b653e38942227b97990345}{RegisterTypeParameterizedTestSuite}}(test\_suite\_name,\ \mbox{\hyperlink{structtesting_1_1internal_1_1_code_location}{CodeLocation}}(file,\ line));}
\DoxyCodeLine{00064\ }
...
\DoxyCodeLine{00075\ \ \ \ \ \textcolor{keyword}{const}\ std::string\&\ \mbox{\hyperlink{namespace_assimp_1_1_d3_m_f_1_1_xml_tag_a121de9e28240c888f0e81487b195bf88}{name}}\ =\ *name\_it;}
\DoxyCodeLine{00076\ \ \ \ \ \textcolor{keywordflow}{if}\ (tests.count(name)\ !=\ 0)\ \{}
\DoxyCodeLine{00077\ \ \ \ \ \ \ errors\ <<\ \textcolor{stringliteral}{"{}Test\ "{}}\ <<\ \mbox{\hyperlink{namespace_assimp_1_1_d3_m_f_1_1_xml_tag_a121de9e28240c888f0e81487b195bf88}{name}}\ <<\ \textcolor{stringliteral}{"{}\ is\ listed\ more\ than\ once.\(\backslash\)n"{}};}
...
\DoxyCodeLine{00084\ \ \ \ \ \ \ errors\ <<\ \textcolor{stringliteral}{"{}No\ test\ named\ "{}}\ <<\ \mbox{\hyperlink{namespace_assimp_1_1_d3_m_f_1_1_xml_tag_a121de9e28240c888f0e81487b195bf88}{name}}}
...
\DoxyCodeLine{00094\ \ \ \}}
\DoxyCodeLine{00095\ }
\DoxyCodeLine{00096\ \ \ \textcolor{keyword}{const}\ std::string\&\ errors\_str\ =\ errors.\mbox{\hyperlink{class_message_a2cdc4df62bdcc9df37651a1cf527704e}{GetString}}();}
\DoxyCodeLine{00097\ \ \ \textcolor{keywordflow}{if}\ (!errors\_str.empty())\ \{}
\DoxyCodeLine{00098\ \ \ \ \ fprintf(stderr,\ \textcolor{stringliteral}{"{}\%s\ \%s"{}},\ \mbox{\hyperlink{namespacetesting_1_1internal_a31b7c3abed4a7c395f42c61e993989f4}{FormatFileLocation}}(file,\ line).c\_str(),}
\DoxyCodeLine{00099\ \ \ \ \ \ \ \ \ \ \ \ \ errors\_str.c\_str());}
\DoxyCodeLine{00100\ \ \ \ \ fflush(stderr);}
\DoxyCodeLine{00101\ \ \ \ \ \mbox{\hyperlink{namespacetesting_1_1internal_1_1posix_a69b8278c59359dd6a6f941b4643db9fb}{posix::Abort}}();}
\DoxyCodeLine{00102\ \ \ \}}
\DoxyCodeLine{00103\ }
