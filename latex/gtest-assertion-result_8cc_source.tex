...
\hypertarget{gtest-assertion-result_8cc_source}{}\label{gtest-assertion-result_8cc_source}\index{RobotLib/libraries/assimp/contrib/googletest/googletest/src/gtest-\/assertion-\/result.cc@{RobotLib/libraries/assimp/contrib/googletest/googletest/src/gtest-\/assertion-\/result.cc}}
\mbox{\hyperlink{gtest-assertion-result_8cc}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-assertion-result_8h}{gtest/gtest-\/assertion-\/result.h}}"{}}}
\DoxyCodeLine{00035\ }
\DoxyCodeLine{00036\ \textcolor{preprocessor}{\#include\ <string>}}
\DoxyCodeLine{00037\ \textcolor{preprocessor}{\#include\ <utility>}}
\DoxyCodeLine{00038\ }
\DoxyCodeLine{00039\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{gtest-message_8h}{gtest/gtest-\/message.h}}"{}}}
\DoxyCodeLine{00040\ }
...
\DoxyCodeLine{00047\ \ \ \ \ \ \ message\_(other.message\_\ !=\ \mbox{\hyperlink{_open_d_d_l_common_8h_ab979d9d4b4923f7c54d6caa6e1a61936}{nullptr}}}
\DoxyCodeLine{00048\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ?\ new\ ::std::\mbox{\hyperlink{namespacedetail_a917c3efabea8a20dc72d9ae2c673d632ab45cffe084dd3d20d928bee85e7b0f21}{string}}(*other.message\_)}
\DoxyCodeLine{00049\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ :\ static\_cast<\ ::std::\mbox{\hyperlink{namespacedetail_a917c3efabea8a20dc72d9ae2c673d632ab45cffe084dd3d20d928bee85e7b0f21}{string}}*>(\mbox{\hyperlink{_open_d_d_l_common_8h_ab979d9d4b4923f7c54d6caa6e1a61936}{nullptr}}))\ \{\}}
\DoxyCodeLine{00050\ }
...
\DoxyCodeLine{00053\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespacestd_a4874fd00297ff5aef2872379cb521783}{std::swap}};}
\DoxyCodeLine{00054\ \ \ \mbox{\hyperlink{pugixml_8cpp_aab8f818e90a34b18c1da140588eca88d}{swap}}(success\_,\ other.success\_);}
\DoxyCodeLine{00055\ \ \ \mbox{\hyperlink{pugixml_8cpp_aab8f818e90a34b18c1da140588eca88d}{swap}}(message\_,\ other.message\_);}
\DoxyCodeLine{00056\ \}}
\DoxyCodeLine{00057\ }
...
\DoxyCodeLine{00066\ AssertionResult\ \mbox{\hyperlink{gtest__unittest_8cc_ac1d0baedb17286c5c6c87bd1a45da8ac}{AssertionSuccess}}()\ \{\ \textcolor{keywordflow}{return}\ AssertionResult(\textcolor{keyword}{true});\ \}}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \textcolor{comment}{//\ Makes\ a\ failed\ assertion\ result.}}
\DoxyCodeLine{00069\ AssertionResult\ \mbox{\hyperlink{gtest__unittest_8cc_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()\ \{\ \textcolor{keywordflow}{return}\ AssertionResult(\textcolor{keyword}{false});\ \}}
\DoxyCodeLine{00070\ }
...
\DoxyCodeLine{00073\ AssertionResult\ \mbox{\hyperlink{gtest__unittest_8cc_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classtesting_1_1_message}{Message}}\&\ message)\ \{}
\DoxyCodeLine{00074\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{gtest__unittest_8cc_a75cb789614cb1c28c34627a4a3c053df}{AssertionFailure}}()\ <<\ message;}
\DoxyCodeLine{00075\ \}}
\DoxyCodeLine{00076\ }
